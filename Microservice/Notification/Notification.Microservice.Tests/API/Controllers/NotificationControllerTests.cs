...
namespace Notification.Microservice.Tests.API.Controllers;
...
public class NotificationControllerTests
{
    ...
    public async Task GetAllNotificationsByUserId_ShouldReturnNotifications()
    {
        ...
        var notifications = new List<NotificationEntity>
        {
            ...
            {
                Id = Guid.NewGuid(), Title = "Test Notification", UserId = userId,
    ...
    public async Task AddNotificationToUserId_ShouldReturnNotification()
    {
        ...
        { UserId = 1, Title = "New Notification", Message = "This is a new notification" };
