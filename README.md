...
## Установка программнго средства

1. Клонирование репозитория
Клонируйте проект из GitHub на локальную машину с помощью команды:

git clone https://github.com/polinaLesak/AstHelp

2. Переход в папку для Docker-компоновки
Перейдите в директорию, где находится конфигурация для Docker, командой:

cd ${PATH_TO_PROJECT}/.docker/prod

где ${PATH_TO_PROJECT} — путь к клонированному репозиторию на вашей локальной машине.
...
###Руководство по использованию ПС для сотрудника


1.Сначала необходимо авторизоваться в приложении.

2.Затем есть возможность добавить товар в корзину.

3.При оформлении заявки необходимо указать причину выдачи оборудования. 

4.Отслеживать выполнение заказов можно на странице “Мои заказы”. При статусе “Готов к выдаче” заказ можно забирать. 

###Руководство по использованию ПС для Ресурсного менеджера
1.Сначала необходимо авторизоваться в приложении.

2.Затем есть возможность добавить товар в корзину.

3.При оформлении заявки необходимо указать причину выдачи оборудования и сотрудника, которому выдается товар. 

4.Отслеживать выполнение заказов и одобрять/отклонять заявки можно на странице “Заказы”. При статусе “Готов к выдаче” заказ можно забирать. Экран представлен на рисунке 8.

###Руководство по использованию ПС для Ресурсного менеджера
1.Сначала необходимо авторизоваться в приложении.

2.Затем есть возможность управлять пользователями.

3.При выдаче оборудования можно выгрузить акт.

4.Отслеживать выполнение заказов можно на странице “Заказы”. При статусе “Готов к выдаче” заказ можно забирать. 
